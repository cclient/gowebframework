...
// WriteError decodes a specific docker error and sends it in the response.
//func WriteError(w http.ResponseWriter, err *errcode.ErrorCode) error {
//	if err == nil || w == nil {
//		logrus.WithFields(logrus.Fields{"error": err, "writer": w}).Error("unexpected HTTP error handling")
//		return nil
//	}
//	errinfo := err.Descriptor()
//	statusCode := errinfo.HTTPStatusCode
//	if statusCode == 0 {
//		statusCode = http.StatusInternalServerError
//	}
//	w.Header().Set("Content-Type", "application/json; charset=utf-8")
//	w.WriteHeader(statusCode)
//	return json.NewEncoder(w).Encode(errinfo)
//}
...
//cdp add
//func Redirect(w http.ResponseWriter, code int, v interface{}) error {
//
//	dest := url.URL{
//					Path:     req.URL.Path + "/",
